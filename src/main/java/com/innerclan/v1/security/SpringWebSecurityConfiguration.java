...
public class SpringWebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // .anyRequest().permitAll();
              //  .antMatchers("/**/*")
        .antMatchers("/api/v1/admin/promo/isValid/*","/api/v1/order/pgresponse","/api/v1/admin/authenticate","/api/v1/admin/**/*","/api/v1/client/ui","/api/v1/subscribe","/api/v1/product/**/*","/api/v1/client/register","/api/v1/client/category","/api/v1/client/authenticate","/api/v1/design/*","api/v1/client/forgotPassword/**/*")
